...
void VMC_init(vmc_leg_t *vmc, fp32 l1, fp32 l2);
void VMC_calc_1(vmc_leg_t *vmc, fp32 Pitch, fp32 PithGyro, fp32 dt);
void VMC_calc_2(vmc_leg_t *vmc);
uint8_t ground_detection(vmc_leg_t *vmc, fp32 g);
vmc_leg_t *Get_VMC_Leg(uint8_t leg);
